...
?>
    ...
    <section>
        <div class="container">
            <p>Pour transmettre des informations, merci de renseigner les informations ci-dessous (par exemple, indiquer des informations erronées, un nouvel opérateur, une nouvelle immatriculation, une nouvelle date de livraison, etc.) <br />Si les informations ne sont pas suffisamment précises, votre correction ne sera pas prise en compte. Ce formulaire ne concerne que l'avion <?php echo "$nomAvion" ?>, MSN <?php echo "$numeroSerieAvion" ?></p>
            <div class="row">
