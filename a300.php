...
<section>
    <!-- BackToTop Button -->
    <a href="javascript:void(0);" id="backToTop" class="back-to-top">s
    ...
    <div class="container">
        ...
        try {
            $query = "SELECT * FROM avion WHERE nom_avion = 'A300'";
                ...
                <div class="col-lg-12 mx-auto">
                    <div class="card rounded shadow border-0">
                        <div class="card-body p-5 bg-white rounded">
                            ...
                            <br>
                            <p style="text-align:right"><a href="./impPDFa300.php">Enregistrer la liste au format PDF</a></p>
                            </div>
                        </div>
                    </div>
                </div>
