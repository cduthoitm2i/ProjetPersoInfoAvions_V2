...
<section>
    ...
    try {
        ...
        $query = "SELECT * FROM compagnie ORDER BY pays_compagnie";
        $result = $pdo->query($query);
        $data = $result->fetch(PDO::FETCH_ASSOC);
    ?>
        <div class="container">
            <h1>Liste par pays</h1>
            <div class="row py-5">
                        ...
                        <div class="card-body p-5 bg-white rounded">
                            <div class="table-responsive">
                                <table id="liste_compagnie" style="width:100%" class="table table-bordered dt-responsive">
                                    <thead>
                                        <tr>
                                            <th style="text-align:center;vertical-align:middle">Pays compagnie</th>
                                ...
                                <br>
                                <p style="text-align:right"><a href="./impPDFcompagniepays.php">Enregistrer la liste au format PDF</a></p>
                            </div>
                        </div>
                    </div>
                </div>
