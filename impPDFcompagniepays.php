<?php
   ...
   try {
      ...
      $sql = "SELECT DISTINCT * FROM compagnie";
      ...
      $pdf->Cell(40, $hauteurEntete, "Pays", 1, 0, 'C', 1);
      $pdf->Cell(60, $hauteurEntete, "Nom de la compagnie", 1, 0, 'C', 1);
      $pdf->Cell(60, $hauteurEntete, "Logo de la compagnie", 1, 0, 'C', 1);
      $pdf->Cell(80, $hauteurEntete, "Site web", 1, 0, 'C', 1);
      $pdf->Cell(30, $hauteurEntete, "Statut", 1, 1, 'C', 1);
      ...
      foreach($curseur as $enregistrement) {
         // Création de la tétière du tableau qui sera répétée à partir de la page 2
          ...
          $pdf->Cell(40, $hauteurLigne, mb_convert_encoding($enregistrement['pays_compagnie'], "ISO-8859-1"), 1 , 0, 'L', 0);
          $pdf->Cell(60, $hauteurLigne, mb_convert_encoding($enregistrement['nom_compagnie'], "ISO-8859-1"), 1 , 0, 'C', 0);
          $pdf->Cell(60, $hauteurLigne, mb_convert_encoding($enregistrement['logo_compagnie'], "ISO-8859-1"), 1 , 0, 'L', 0);
          $pdf->Cell(80, $hauteurLigne, mb_convert_encoding($enregistrement['site_web_compagnie'], "ISO-8859-1"), 1 , 0, 'L', 0);
          $pdf->Cell(30, $hauteurLigne, mb_convert_encoding($enregistrement['statut_compagnie'], "ISO-8859-1"), 1 , 1, 'L', 0);
      ...
      $pdf->Output('D', 'listeCompagniepays.pdf', true);
   }
