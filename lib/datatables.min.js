...
(function (h) {
  ...
  function Ca(a) {
    ...
    if (a) {
      ...
      !a.sEmptyTable &&
        d &&
        "Pas de données disponible pour ce modèle d'avion" === b.sEmptyTable &&
        F(a, a, "sZeroRecords", "sEmptyTable");
      !a.sLoadingRecords &&
        d &&
        "Charger..." === b.sLoadingRecords &&
  ...
  n.defaults = {
    ...
    oLanguage: {
      ...
      sEmptyTable: "Pas de données disponible pour ce modèle d'avion",
      sInfo: "Afficher&nbsp: _START_ à _END_ de _TOTAL_ entrées",
      sInfoEmpty: "Afficher&nbsp: 0 à 0 de 0 entrées",
      sInfoFiltered: "(filter de _MAX_ total entrées)",
      sInfoPostFix: "",
      sDecimal: "",
      sThousands: ",",
      sLengthMenu: "Affichage _MENU_ entrées",
      sLoadingRecords: "Charger...",
      sProcessing: "En cours...",
      sSearch: "Rechercher&nbsp;:",
      sSearchPlaceholder: "",
      sUrl: "",
      sZeroRecords: "Aucune entrées trouvées",
    },
